...
class KGEArgParser:
    ...
    def __init__(self):
        ...
        self.general_group.add_argument('--data', dest='dataset_name', default='Freebase15k', type=str, help='The dataset name (choice: fb15k/wn18/wn18_rr/yago/fb15k_237/ks/nations/umls)')
        self.general_group.add_argument('--model', dest='model_name', default='TransE', type=str, help='Name of model')
        self.general_group.add_argument('--data_dir', dest='dataset_path', default=None, type=str, help='The path to custom dataset.')
        self.general_group.add_argument('--load_dir', dest='load_from_data', default=None, type=str, help='The path to the pretrained model.')
        self.general_group.add_argument('--t', dest='tmp', default='../models', type=str, help='The folder name to store trained parameters.')
        ...
        self.general_hyper_group.add_argument('--batch_size', dest='batch_size', default=128, type=int, help='training batch size')
        ...
        self.general_hyper_group.add_argument('--epochs', dest='epochs', default=100, type=int, help='The total number of Epochs')
        self.general_hyper_group.add_argument('--learning_rate', dest='learning_rate', default=0.01, type=float, help='learning rate')
        self.general_hyper_group.add_argument('--ent_dim', dest='ent_hidden_size', default=50, type=int, help="Hidden embedding size for entities.")
        self.general_hyper_group.add_argument('--rel_dim', dest='rel_hidden_size', default=50, type=int, help="Hidden embedding size for relations.")
